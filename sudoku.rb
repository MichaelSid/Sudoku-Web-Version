...
def box_order_to_row_order(cells)
	...
	(0..8).to_a.inject([]) {|memo, i|
		#we're dividing an integer by an integer, it's called an integer division, the result 
		#will be also be an integer, e.g. 0/3=0,
		#1/3=0, 2/3=0, 3/3=1, 4/3-1, etc.
		#Then we multiply it by the numbers of rows in a box.
		#This gives us the index of the first box that contains the digits for index i.
